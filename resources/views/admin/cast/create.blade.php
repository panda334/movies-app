        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           <div class="m-2 p-2">
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('admincasts.store') }}"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                            ...
                            class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition-none @error('job') border-red-400 @enderror"></textarea>
                        </div>
                        @error('job')
                        <div class="text-sm text-red-400">{{ $message }}</div>
                    @enderror
